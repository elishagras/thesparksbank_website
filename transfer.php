...
if(isset($_POST['submit']))
{
    ...
    if (($amount)<0)
   {
    ...
    // constraint to check zero values
      ...
      echo "<script type='text/javascript'>";
      echo "alert('More than Rs 100 can only be transferred')";
      echo "</script>";
    }
...
<html lang="en">
 ...
 <body>
    ...
    <div class="container-transfer">
        ...
        <br><br><br>
        <div class="alltext">
        <label class="belowtable">Transfer To:</label>
        <select name="to" class="belowtable form-control" required>
            <option class="belowtable" value="" disabled selected>Choose</option>
             <?php
                include 'config.php';
                $sid=$_GET['id'];
                $sql = "SELECT * FROM users where id!=$sid";
        ...
        <br>
        <br>
            <label class="belowtable">Amount:</label>
            <input type="number" class="form-control" name="amount" required>   
            <br><br>
                <div class="text-center" >
            <button class="btn mt-3 btn-primary button-table" name="submit" type="submit" id="myBtn">Transfer</button>
            </div>
            </div>
        </form>
